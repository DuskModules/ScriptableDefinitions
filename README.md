...
This module supports automatic optional dependencies between other modules. Certain modules have bits of functionality connecting one another together, but a hard dependency would break the framework being modular. The extra code is simply never compiled if the required module is not present within a project.
...
You can simply download and import the **ScriptingDefinitions.unitypackage** into your Unity Project manually. (TODO: Add package release branch)

Or you can go to the ScriptingDefinitions Asset Store page and download it from there. (TODO: Add AssetStore page)
...
```
$ git submodule add https://github.com/DuskModules/ScriptingDefinitions Assets/DuskModules/1-UtilityModules/ScriptingDefinitions
```
...
https://sites.google.com/dusklightstudios.com/duskmodules/utility-modules/scriptingdefinitions
